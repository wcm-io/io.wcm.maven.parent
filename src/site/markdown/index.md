...
* [Sling-Initial-Content JSON Strip Comments Maven Plugin](plugins/sling-initial-content-json-strip-comments-maven-plugin/): Removes all comments from JSON files in Sling-Initial-Content.
